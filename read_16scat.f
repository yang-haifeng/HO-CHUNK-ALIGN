...
c     mH = 1.67d-24 (grams of mH)
      ...
      open(unit=66,file="kappa.txt",form='formatted')
c     open(unit=66,file=filename,form='unformatted')
c     open(unit=99,file="kappa.txt",form='formatted',action='write')

c ... get file array size info
      read(66,*) nwav,nthetab,ntheta,ndphi
c     write(99,*) nwav,nthetab,ntheta,ndphi
      print*,' NWAV = ',nwav
